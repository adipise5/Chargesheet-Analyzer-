...
export const api = {
  ...
  // Analytics endpoints
  analyticsSummary: (includeReferenceRecords = false) => request<Record<string, number>>(`/analytics/summary?include_reference_records=${includeReferenceRecords}`),
  analyticsCrimeTypes: (includeReferenceRecords = false) => request<Array<{ section: string; count: number }>>(`/analytics/crime-types?include_reference_records=${includeReferenceRecords}`),
  analyticsTemporal: (includeReferenceRecords = false) => request<Array<{ month: string; cases_registered: number; cases_extracted: number; crime_events: number }>>(`/analytics/temporal?include_reference_records=${includeReferenceRecords}`),
  analyticsHotspots: (includeReferenceRecords = false) => request<Array<{ station: string; count: number }>>(`/analytics/hotspots?include_reference_records=${includeReferenceRecords}`),
  analyticsCaseStatus: (includeReferenceRecords = false) => request<Array<{ status: string; count: number }>>(`/analytics/case-status?include_reference_records=${includeReferenceRecords}`),
  analyticsEvidenceProfile: (includeReferenceRecords = false) => request<Array<{ type: string; count: number }>>(`/analytics/evidence-profile?include_reference_records=${includeReferenceRecords}`),
  analyticsEntityNetwork: (includeReferenceRecords = false) => request<Array<{ label: string; kind: string; case_count: number }>>(`/analytics/entity-network?include_reference_records=${includeReferenceRecords}`),
  analyticsFindings: (includeReferenceRecords = false) => request<Array<{ type: string; count: number }>>(`/analytics/findings-summary?include_reference_records=${includeReferenceRecords}`),
  analyticsDocRoles: (includeReferenceRecords = false) => request<Array<{ role: string; count: number }>>(`/analytics/document-roles?include_reference_records=${includeReferenceRecords}`),
}
